...
```{r}
#| label: intersect_all_data_graph
#| tbl-cap: Line Graph of Common Mortality Causes of South Korea
#| echo: false

korea_poisson <- readRDS("/Users/hyukjang/Top Mortality Causes South Korea/starter_folder-main/models/cause_of_death_south_korea_poisson.rds")
korea_neg_bin <- readRDS("/Users/hyukjang/Top Mortality Causes South Korea/starter_folder-main/models/cause_of_death_south_korea_neg_binomial.rds")
coef_short_names <-
...
modelsummary(
  list(
    "Poisson" = korea_poisson,
    "Negative binomial" = korea_neg_bin
  ),
