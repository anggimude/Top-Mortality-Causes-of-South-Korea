...
subtitle: "Poisson and Negative Bionimal Modelling of Annual Death Number and its Cause"
author: 
  - Hyuk Jang
...
common_all_data|>
  ggplot(aes(x = Year, y = Deaths, color = Cause)) +
  geom_line() +
  ggtitle("Mortality Causes Appearing at least twice") +
  xlab("Year") +
  ylab("Annual Number of Deaths in South Korea") +
  theme_minimal() +
  scale_x_continuous(breaks = unique(merged_selected$Year)) +
...
next step talking about how the relseae of this paper may let people understand and be shocked from the data because  normally people don't get to see a graph will lots of the top causes of death plotted over time and thus don't realize it is more serious than what people think and be more aware of their health and surroundings. 
